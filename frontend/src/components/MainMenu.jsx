...
export const MainMenu = ({ setView, branding }) => {
    const logoSrc = (branding && branding.primary_logo && branding.primary_logo !== "") ? branding.primary_logo
        : (branding && branding.system_logo && branding.system_logo !== "") ? branding.system_logo
        : logoImage;
    const circleClass = branding?.circle_logo_format ? "rounded-full" : "rounded-none";
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-8 h-full">
            ...
            <div className="flex flex-col items-center mb-16 text-white animate-in slide-in-from-bottom-5 fade-in duration-700">
                <div className="h-48 w-48 mb-6 flex items-center justify-center drop-shadow-2xl">
                    <img src={logoSrc} alt="System Logo" className={`w-full h-full object-contain filter drop-shadow-[0_10px_15px_rgba(0,0,0,0.5)] ${circleClass}`} />
                </div>
